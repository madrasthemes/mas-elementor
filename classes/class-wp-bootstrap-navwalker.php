...
if ( ! class_exists( 'MAS_Bootstrap_Navwalker' ) ) :
	...
	class MAS_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'mas-elementor' ) . '">' . esc_html__( 'Add a menu', 'mas-elementor' ) . '</a></li>';
			$fallback_output .= '</ul>';
