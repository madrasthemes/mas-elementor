...
namespace MASElementor\Modules\Footer\Widgets;
...
class Footer extends Base_Widget {
	...
	public function get_title() {
		return esc_html__( 'Footer', 'mas-addons-for-elementor' );
	}
	...
	public function get_keywords() {
		return array( 'footer', 'quote', 'paragraph', 'testimonial', 'text', 'twitter', 'tweet' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Footer', 'mas-addons-for-elementor' ),
			)
		);

		$slug_options = function_exists( 'mas_template_slug_options' ) ? mas_template_slug_options( 'mas-footer' ) : array();
		$this->add_control(
			'slug_select_template',
			array(
				'label'   => esc_html__( 'MAS Footers', 'mas-addons-for-elementor' ),
