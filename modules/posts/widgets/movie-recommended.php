 ...
 * Class Posts
 */
class Movie_Recommended extends Posts_Base {
	...
	public function get_keywords() {
		return array( 'posts', 'cpt', 'item', 'loop', 'query', 'cards', 'custom post type', 'movie', 'recommended' );
	}
	...
	public function render() {
		...
		foreach ( $recommended_movies as $recommended_movie ) {
			$post_object = get_post( $recommended_movie );
