    ...
    class LoadMore extends elementorModules.frontend.handlers.Base {
        ...
        bindEvents() {
            ...
            this.elements.loadMoreButton.addEventListener('click', event => {
                ...
                var newDoc = event.target.closest("[data-loader]");
        ...
        handleInfiniteScroll() {
            ...
            this.observer = elementorModules.utils.Scroll.scrollObserver({
                callback: event => {
                    ...
                    this.handlePostsQuery(this.elements.loadMoreAnchor.dataset.scrollid).then(() => {
                        if (this.currentPage !== this.maxPage) {
        ...
        handleSuccessFetch(result, loadId) {
			var loadSelector;
			if ( loadId ) {
				loadSelector = '.' + loadId + '.mas-posts-container > .elementor';
			} else {
				loadSelector = '.mas-posts-container > .elementor'
			}
            this.handleUiAfterLoading();
            const posts = result.querySelectorAll(loadSelector);
            const nextPageUrl = result.querySelector('.e-load-more-anchor').getAttribute('data-next-page');
            // Converting HTMLCollection to an Array and iterate it.
            ...
            const event = new CustomEvent( 'mas-posts', { 
                detail : {
        ...
        handlePostsQuery(loadId) {
            ...
            return fetch(nextPageUrl).then(response => response.text()).then(html => {
                ...
                this.handleSuccessFetch(doc, loadId);
            }).catch(err => {
