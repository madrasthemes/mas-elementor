            ...
            var a = (function () {
                function e(t) {
                    if (
                        ...
                        (a.innerHTML = t.label), o.classList.add("darkmode-layer"), d.classList.add("darkmode-background");
...
/*dark mode */ (function (a) {
    var b = function (a, b) {
        b("body").hasClass("darkmode--activated") && b(".darkmode-toggle").addClass("darkmode-toggle--white");
        var c = a.find(".tp-dark-mode-wrapper"),
            d = c.data("time"),
            e = c.data("dm_mixcolor"),
            f = c.data("bgcolor"),
            g = c.data("save-cookies"),
            h = c.data("auto-match-os-theme"),
            i = c.data("style"),
            j = "";
        b("body").addClass(i), (j = "tp_dm_style2" == i ? '<span class="tp-dark-mode-slider tp-dark-mode-round "></span>' : "\uD83C\uDF13");
        var k = { left: "unset", time: d, mixColor: e, backgroundColor: f, buttonColorDark: "#100f2c", buttonColorLight: "#fff", saveInCookies: g, label: j, autoMatchOsTheme: h };
        const l = new Darkmode(k);
        l.showWidget();
    };
    a(window).on("elementor/frontend/init", function () {
        elementorFrontend.hooks.addAction("frontend/element_ready/tp-dark-mode.default", b);
    });
})(jQuery);