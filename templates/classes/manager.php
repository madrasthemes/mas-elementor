...
if ( ! class_exists( 'Premium_Templates_Manager' ) ) {
	...
	class Premium_Templates_Manager {
		...
		public function __construct() {
			...
			add_filter( 'mas_elementor_templates_editor_localize', array( $this, 'localize_tabs' ) );
		...
		public function register_sources() {
			...
			require MAS_ELEMENTOR_TEMPLATES_PATH . 'sources/base.php';
			...
			foreach ( $sources as $key => $class ) {
				...
				require MAS_ELEMENTOR_TEMPLATES_PATH . 'sources/' . $key . '.php';
