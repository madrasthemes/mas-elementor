...
namespace MASElementor\Templates\Sources;
...
abstract class Premium_Templates_Source_Base {
	...
	public function templates_key() {
		return 'mas_premium_templates_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function categories_key() {
		return 'mas_premium_categories_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function keywords_key() {
		return 'mas_premium_keywords_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function is_debug_active() {
		...
		if ( 1 || defined( 'PREMIUM_API_DEBUG' ) && true === PREMIUM_API_DEBUG ) {
			return true;
		} else {
			return false;
		}
