...
namespace MASElementor\Templates;
...
if ( ! class_exists( 'Premium_Templates' ) ) {
	...
	class Premium_Templates {
		...
		private function load_files() {
			...
			require MAS_ELEMENTOR_TEMPLATES_PATH . 'classes/config.php';

			require MAS_ELEMENTOR_TEMPLATES_PATH . 'classes/assets.php';

			require MAS_ELEMENTOR_TEMPLATES_PATH . 'classes/manager.php';

			require MAS_ELEMENTOR_TEMPLATES_PATH . 'types/manager.php';

			require MAS_ELEMENTOR_TEMPLATES_PATH . 'classes/api.php';
